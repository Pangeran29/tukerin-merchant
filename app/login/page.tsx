    ...
    <div className="flex min-h-screen bg-gray-100">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex justify-center">
            <div className="w-48 h-12 bg-[#FDDF23] rounded-lg flex items-center justify-center">
              <Coffee className="w-8 h-8 text-black mr-2" />
              <span className="text-2xl font-bold text-black">CoffeeRewards</span>
            </div>
          </div>

          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900">Welcome Back!</h2>
            <p className="mt-2 text-gray-600">Please sign in to your account to manage your loyalty program</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-10 bg-white border-gray-300 focus:border-[#FDDF23] focus:ring-[#FDDF23]"
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center p-12">
          <h1 className="text-4xl font-bold text-white mb-4">Boost Your Coffee Shop Loyalty</h1>
          <p className="text-xl text-white text-center max-w-md">
            Manage your rewards program, track customer engagement, and grow your business with our powerful CMS.
          </p>
        </div>
      </div>
    </div>
